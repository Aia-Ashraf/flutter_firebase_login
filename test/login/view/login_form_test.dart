...
void main() {
  const loginButtonKey = Key('LoginFormWidget_continue_raisedButton');
  const emailInputKey = Key('LoginFormWidget_emailInput_textField');
  const passwordInputKey = Key('LoginFormWidget_passwordInput_textField');
  const createAccountButtonKey = Key('LoginFormWidget_createAccount_flatButton');
