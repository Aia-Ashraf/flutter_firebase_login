  ...
  group('BaseBlocObserver', () {
    ...
    test(
      ...
      overridePrint(() {
        ...
        BaseBlocObserver().onEvent(bloc, event);
    ...
    test(
      ...
      overridePrint(() {
        ...
        BaseBlocObserver().onError(bloc, error, stackTrace);
    ...
    test(
      ...
      overridePrint(() {
        ...
        BaseBlocObserver().onChange(cubit, change);
    ...
    test(
      ...
      overridePrint(() {
        ...
        BaseBlocObserver().onTransition(bloc, transition);
